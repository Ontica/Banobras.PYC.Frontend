...
export enum TransactionEntriesTableEventType {
  SELECT_ENTRY_CLICKED = 'TransactionEntriesTableComponent.Event.SelectEntryClicked',
  REMOVE_ENTRY_CLICKED = 'TransactionEntriesTableComponent.Event.RemoveEntryClicked',
}
...
export class TransactionEntriesTableComponent implements OnChanges {
